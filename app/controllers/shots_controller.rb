class ShotsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @shot.save
        format.html { redirect_to @shot, notice: 'Book successfully added.' }
  ...
  def update
    respond_to do |format|
      if @shot.update(shot_params)
        format.html { redirect_to @shot, notice: 'Book successfully edited.' }
  ...
  def destroy
    @shot.destroy
    respond_to do |format|
      format.html { redirect_to shots_url, notice: 'Book successfully removed.' }
